...
# ----------------------------------------------------------------------------------------
# BIOL595 Final Project: Literature Analysis (Part I)
# Use the script below which is obtained from NCBI Ebot with a little modification to 
# fetch information from NCBI database and obtain a xml file.
# Ebot, part of the materials of the NCBI PowerScripting course, is found from website:
# (http://www.ncbi.nlm.nih.gov/Class/PowerTools/eutils/ebot.cgi)(Author:  Eric W. Sayers).
# Alexandr Pak, Krittikan Chanpaisaeng, & Xin Wen, April 4 2016
# ----------------------------------------------------------------------------------------
...
print "Please enter the term you want to search:\n";
my $term = <>;
chomp $term;
open (my $out, ">", "term.txt")|| die "Cannot open output file.\n";
print $out "$term";
close ($out);
$params{email} = "wen45@purdue.edu";
$params{db} = "pubmed";
$params{tool} = "ebot";
$params{term} = "$term";
...
#*************************************************************
#** ALL BELOW IS WRITTEN BY Eric W. Sayers *******************
#*************************************************************
